...
export default function GlobalMonitoring({ mode: globalMode }: GlobalMonitoringProps) {
  const [localMode, setLocalMode] = useState<Mode>('counting');
  const mode: Mode = globalMode
      ...
      <header className="dashboard-header">
        <div>
          ...
          <p className="text-muted text-sm mt-1">
            Factory overview and edge node status
            {globalMode ? ` (${globalMode} Mode)` : ''}
          </p>
