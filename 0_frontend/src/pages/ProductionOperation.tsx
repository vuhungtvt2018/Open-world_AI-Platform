...
export default function ProductionOperation({ mode: globalMode = 'INSPECTION' }: ProductionOperationProps) {
  const mode: Mode = globalMode === 'COUNTING' ? 'counting' : 'inspection';
    ...
    <div className="production-container">
      <header className="page-header">
        <div className="header-info">
          ...
          <p className="text-muted">Real-time control and synchronization with Edge Nodes & PLC ({globalMode} Mode)</p>
        </div>
