...
from vision_ai_platform.packages.utils.check import check_file, check_font, is_ascii, normalize_platform_uri
from vision_ai_platform.packages.utils.downloads import download, safe_download, unzip_file
from vision_ai_platform.packages.utils.ops import segments2boxes
...
def convert_ndjson_to_yolo_if_needed(data: str | Path) -> str | Path:
    ...
    if clean_url(data_str).endswith(".ndjson") or (data_str.startswith("ul://") and "/datasets/" in data_str):
        ...
        from vision_ai_platform.packages.utils.converter import convert_ndjson_to_yolo
