...
from vision_ai_platform.packages.ai.models.yolo.detect import DetectionPredictor
from vision_ai_platform.packages.ai.models.yolo.segment import SegmentationPredictor
