...
from vision_ai_platform.packages.utils import RANK, colorstr
...
class RTDETRTrainer(DetectionTrainer):
    ...
    def build_dataset(self, img_path: str, mode: str = "val", batch: int | None = None):
        ...
        return RTDETRDataset(
            ...
            data=self.data,
            fraction=self.cfg.fraction if mode == "train" else 1.0,
        )

    def get_validator(self):
        """Return an RTDETRValidator suitable for RT-DETR model validation."""
        self.loss_names = "giou_loss", "cls_loss", "l1_loss"
        return RTDETRValidator(self.test_loader, save_dir=self.save_dir, args=copy(self.cfg))
