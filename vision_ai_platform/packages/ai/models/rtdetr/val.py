...
from vision_ai_platform.packages.utils import colorstr, ops
...
class RTDETRValidator(DetectionValidator):
    ...
    def postprocess(
        ...
        bboxes = ops.xywh2xyxy(bboxes) * self.cfg.imgsz
        scores, labels = scores.squeeze(-1), labels.squeeze(-1)
        masks = [(score > self.cfg.conf).nonzero().squeeze(1)[: self.cfg.max_det] for score in scores]
    ...
    def pred_to_json(self, predn: dict[str, torch.Tensor], pbatch: dict[str, Any]) -> None:
        ...
        box[..., [0, 2]] *= pbatch["ori_shape"][1] / self.cfg.imgsz  # native-space pred
        box[..., [1, 3]] *= pbatch["ori_shape"][0] / self.cfg.imgsz  # native-space pred
