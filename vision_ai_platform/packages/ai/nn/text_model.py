...
from vision_ai_platform.packages.utils import WEIGHTS_DIR, check
from vision_ai_platform.packages.utils.device_utils import smart_inference_mode

try:
    import clip
except ImportError:
    check.check_requirements("git+https://github.com/ultralytics/CLIP.git")
    import clip
...
class MobileCLIP(TextModel):
    ...
    def __init__(self, size: str, device: torch.device) -> None:
        ...
        try:
            ...
            check.check_requirements("git+https://github.com/ultralytics/mobileclip.git")
            import mobileclip
