...
class RTDETRDetectionModel(DetectionModel):
    ...
    def init_criterion(self):
        ...
        from vision_ai_platform.packages.ai.utils.loss import RTDETRDetectionLoss
...
class WorldModel(DetectionModel):
    ...
    def get_text_pe(self, text, batch=80, cache_clip_model=True):
        ...
        """
        from vision_ai_platform.packages.ai.nn.text_model import build_text_model
...
class YOLOEModel(DetectionModel):
    ...
    def loss(self, batch, preds=None):
        ...
        """
        if not hasattr(self, "criterion"):
            from vision_ai_platform.packages.utils.loss import TVPDetectLoss
...
class YOLOESegModel(YOLOEModel, SegmentationModel):
    ...
    def loss(self, batch, preds=None):
        ...
        """
        if not hasattr(self, "criterion"):
            from vision_ai_platform.packages.utils.loss import TVPSegmentLoss
...
class _SafeLoad:
    ...
    def _build(cls):
        ...
        import vision_ai_platform.packages.ai.nn.modules as ul_nn
        from vision_ai_platform.packages.ai.nn import tasks as ul_tasks  # noqa: PLW0406
        ...
        from vision_ai_platform.packages.utils.loss import E2EDetectLoss
...
def torch_safe_load(weight, safe_only=None):
    ...
    """
    from vision_ai_platform.packages.utils.downloads import GITHUB_ASSETS_NAMES, attempt_download_asset
