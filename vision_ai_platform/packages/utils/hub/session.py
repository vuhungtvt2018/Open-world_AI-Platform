...
from vision_ai_platform.packages.utils.hub.utils import HELP_MSG, HUB_WEB_ROOT, PREFIX, HUBModelError
from vision_ai_platform.packages.utils import IS_COLAB, LOGGER, SETTINGS, check
...
class HUBTrainingSession:
    ...
    def load_model(self, model_id: str):
        ...
        if self.model.is_trained():
            ...
            self.model_file = check.check_file(url, download_dir=Path(SETTINGS["weights_dir"]) / "hub" / self.model.id)
            return
    ...
    def _set_train_args(self):
        ...
        self.model_file = check.check_yolov5u_filename(self.model_file, verbose=False)  # YOLOv5->YOLOv5u
