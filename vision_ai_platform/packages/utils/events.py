...
from vision_ai_platform import SETTINGS, __version__
from vision_ai_platform.packages.utils import ARGV, ENVIRONMENT, GIT, IS_PIP_PACKAGE, ONLINE, PYTHON_VERSION, RANK, TESTS_RUNNING
from vision_ai_platform.packages.utils.downloads import GITHUB_ASSETS_NAMES
