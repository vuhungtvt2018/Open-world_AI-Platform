...
from . import ASSETS_URL, LOGGER, clean_url, emojis, is_online, url2file, check
...
def attempt_download_asset(
    ...
    **kwargs,
    ...
    """
    from vision_ai_platform.packages.utils import SETTINGS  # scoped for circular import

    # YOLOv3/5u updates
    file = str(file)
    file = check.check_yolov5u_filename(file)
