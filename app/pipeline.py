...
from .database.crud import create_inspection_record
...
class Pipeline:
    ...
    def _post_qc(self, file_path: str, description: str, inspection_time_str: str, actual_result: str):
        ...
        try:
            with open(file_path, "rb") as f:
                ...
                r = requests.post(url, data=data, files=files, timeout=float(self.cfg.API_TIMEOUT), proxies={"http": None, "https": None})
    ...
    def _classify_defect(self, img_path: str) -> Optional[Dict]:
        ...
        try:
            with open(img_path, "rb") as f:
                ...
                r = requests.post(self.cfg.DEFECT_CLS_URL, data=data, files=files, timeout=float(self.cfg.API_TIMEOUT), proxies={"http": None, "https": None})
    ...
    def run(self):
        ...
        try:
            while True:
                live = cv2.imread('IMG_20250904_171143_200732.jpg')
                # live = cam.read()
                ...
                if key == 32:  # SPACE
                    ...
                    record = {
                        ...
                        "latency_ms": 0.0,  # Or calculate latency if needed
                        "objects": per_objects
                    }
