...
from packages.utils.utils import (ts, ensure_dirs, pad_and_clip_box, need_clean, clean_data, 
                    arrow_angle, rotate_image, transform_points, union_box, compute_iou)
from packages.utils.visualize import draw_preview, concat_anomaly_crops
    ...
    def _classify_defect(self, image_path: str) -> Optional[Dict]:
        ...
        try:
            with open(image_path, "rb") as f:
                ...
                resp = requests.post(url, files=files, data=data, timeout=3.0)
